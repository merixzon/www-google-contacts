...
my $rel_with_type = WWW::Google::Contacts::Type::Relation->new({ type => "child", value => "Arne" });
...
my $rel_with_label = WWW::Google::Contacts::Type::Relation->new({ label => "stripe buddy", value => "Arne" });
...
$rel_with_label = WWW::Google::Contacts::Type::Relation->new({ label => "mother", value => "Arne" });
$xml_hashref = $rel_with_label->to_xml_hashref;
